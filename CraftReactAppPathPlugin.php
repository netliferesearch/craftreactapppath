...
class CraftReactAppPathPlugin extends BasePlugin
{
    /**
    ...
    {
         return Craft::t('craftReactAppPath');
    }
    ...
    {
        return Craft::t('Returns string to create-react-app build files');
    }
    ...
    {
        return 'https://github.com/kmelve/craftreactapppath/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/kmelve/craftreactapppath/master/releases.json';
    }
    ...
    {
        Craft::import('plugins.craftreactapppath.twigextensions.CraftReactAppPathTwigExtension');

        return new CraftReactAppPathTwigExtension();
    }
